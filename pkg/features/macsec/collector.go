...
func (c *macsecCollector) collectForInterfaces(sessions ShowSecMacsecConns, ch chan<- prometheus.Metric, labelValues []string) {
	for _, mici := range sessions.MacsecConnectionInformation {
