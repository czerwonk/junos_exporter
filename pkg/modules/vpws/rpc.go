...
type result struct {
	Information struct {
		VpwsInstances []instance `xml:"evpn-vpws-instance"`
...
type instance struct {
	...
	Interfaces []iface `xml:"evpn-vpws-interface-status-table>evpn-vpws-interface"`
}
...
type iface struct {
	...
	LocalStatus struct {
		...
		SidPeInfo []sidPEInfo `xml:"evpn-vpws-sid-pe-status-table>evpn-vpws-sid-pe-info"`
